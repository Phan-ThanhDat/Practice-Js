...
<div class="list__infos">
    ...
    <div class="input">
    <input type="text" class="input__adding" value="Full name">
    <input type="email" class="input__adding input__adding--mail" value="E-mail address">
    <input type="tel" class="input__adding" value="Phone number">
    </div>
...
<div class="list__cover-icons">
    ...
    <input type="email" class="input__editing input__editing--mail" value="george.clooney@hollywood.com">
...
let programe1 = (function () {

    let className = document.getElementsByClassName("list");

    function removeTextInput(a) {
        if (a.target.tagName === 'input' || a.target.tagName.toLowerCase() === 'input') {
            a.target.value = ' '
        }
    }

    function preventLoadPage(a) {
        console.log(a);
    }

    function doSomethingPrivate(a) {
        console.log(a)
    }
    ...
    return {
        ...
        init : function()  {
            className[0].addEventListener("click", function (a) {

                //this.removeTextInput_pub(e);
                apply(programe1).preventLoadPage_pub(5)
                //console.log('demo123');
